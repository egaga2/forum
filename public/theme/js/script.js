!function (e) {
    ...
    var t = e(window);
    t.on("load", function () {
        var o = e(document), a = e("html, body"), n = e("body"), s = e("#preloader"), l = e(".toggle-password"),
            i = e(".user-text-editor"), r = e(".js-tilt"), c = e(".gallery-carousel"), d = e(".recruiting-carousel"),
            p = e(".testimonial-carousel"), v = e("#phone"), h = e(".cv-input"), g = e(".select-container"),
            u = e(".limit-select"), f = e(".input-tags"), m = e(".lazy"), w = e(".case-card"), y = e(".qtyBtn"),
            b = e('[data-fancybox="company-detail-gallery"]'), x = e("#back-to-top");
        s.delay("500").fadeOut(2e3), e(".search-menu-toggle").on("click", function () {
            ...
            e(this).scrollTop() > 5 ? (e(".header-area").addClass("fixed-top"), n.css("margin-top", e(".header-area").outerHeight() + "px")) : (e(".header-area").removeClass("fixed-top"), n.css("margin-top", "0")), e(this).scrollTop() >= 300 ? x.show(200) : x.hide(200), function () {
        ...
        const C = document.querySelector(".toggle-input"), k = document.querySelectorAll(".price-month"),
        ...
        }), i.length && i.jqte({formats: [["p", "Paragraph"], ["h1", "Heading 1"], ["h2", "Heading 2"], ["h3", "Heading 3"], ["h4", "Heading 4"], ["h5", "Heading 5"], ["h6", "Heading 6"], ["pre", "Preformatted"]]}), o.on("click", ".login-btn", function () {
        ...
        o.on("click", ".generic-tabs .nav-link", function () {
            var t = e(this).parent().position(), o = e(this).parent().width();
            z.css({left: +t.left, width: o})
        });
        var T = e(".generic-tabs").find(".active").parent("li").width(), M = e(".generic-tabs .active").position();
        z.length && z.css({left: +M.left, width: T}), o.on("click", "#delete-terms", function () {
            var t = e("#delete-button");
            e(this).is(":checked") ? t.removeAttr("disabled") : t.attr("disabled", !0)
        }), o.on("click", ".copy-btn", function (t) {
            t.preventDefault();
            var o = e(".copy-input"), a = e(".text-success-message");
            o.select(), document.execCommand("copy"), o.blur(), a.addClass("active"), setTimeout(function () {
                a.removeClass("active")
            }, 2e3)
        }), r.length && r.tilt({maxTilt: 3, scale: 1.02}), c.length && c.owlCarousel({
            items: 3,
            loop: !0,
            margin: 15,
            smartSpeed: 800,
        ...
        var H, S = document.querySelector("#send-message-btn"), q = e(".contact-form"),
        ...
        q.submit(function (t) {
            t.preventDefault(), H = e(this).serialize(), S.innerHTML = "Sending...", setTimeout(function () {
                e.ajax({type: "POST", url: q.attr("action"), data: H}).done(B).fail(I)
            }, 2e3)
        }), y.length && y.on("click", function () {
            var t = e(this), o = t.parent().find(".qtyInput").val();
            if (t.hasClass("qtyInc")) var a = parseFloat(o) + 1; else a = o > 0 ? parseFloat(o) - 1 : 0;
