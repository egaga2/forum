                                ...
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" name="description"
                                                  placeholder="@lang('admin.short_description')">{{$news->description}}</textarea>
                                    </div>
                                    <div class="form-group">
                                        <label>@lang('admin.article') <span class="text-danger">*</span></label>
                                        <textarea class="form-control html-editor-cm" name="details"
                                                  placeholder="@lang('admin.article')">{{$news->details}}</textarea>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="title_seo" class="form-control" placeholder="Title for seo" value="{{$news->title_seo}}"/>
                                    </div>
                                    <div class="form-group">
                                        <label>Description for seo</label>
                                        <textarea class="form-control" name="description_seo"
                                                  placeholder="Description for seo">{{$news->description_seo}}</textarea>
                                    </div>
                                </div>
                                <!-- /.box-body -->

                                <div class="box-footer">
                                    <button type="submit" class="btn btncus btn_blue">Update New</button>
                                </div>
