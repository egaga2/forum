...
<head>
	...
	<link rel="stylesheet" href="{{ asset('public/theme/install/css/bootstrap.min.css') }}">
	<link rel="stylesheet" href="{{ asset('public/theme/install/css/fontawesome-all.min.css') }}">
	<link rel="stylesheet" href="{{ asset('public/theme/install/css/font.css') }}">
	<link rel="stylesheet" href="{{ asset('public/theme/install/css/default.css') }}">
	<link rel="stylesheet" href="{{ asset('public/theme/install/css/style.css') }}">

	<link rel="shortcut icon" type="image/x-icon" href="{{ asset('public/theme/install/img/favicon.ico') }}">
...
<body>
	...
	<script src="{{ asset('public/theme/install/js/vendor/jquery-3.5.1.js') }}"></script>
	<script src="{{ asset('public/theme/install/js/install/install.js') }}"></script>
</body>
</html>