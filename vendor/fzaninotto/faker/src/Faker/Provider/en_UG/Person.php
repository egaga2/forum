...
class Person extends \Faker\Provider\Person
{
    ...
    protected static $firstNameMale = array(
        ...
        'Jabari','Jack','Jackson','Jacob','Jamaal','Jamal','Jasper','Jayson','Jeff','Jeffery','Jeremy','Jimmy','Joe','Joel','Joesph','Johathan','John','Johnathan','Johnny','Johnson','Rendy','Jordan','Joseph','Joshua','Julian','Julio','Julius','Junior',
